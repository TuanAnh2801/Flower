        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form action="{{ url("admin/posts/updateCategoryPosts/{$categories->id}") }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input name="name" type="text"
                                        ...
                                        placeholder="name_category" value="{{ $categories->name }}">
                                    @error('name')
                            ...
                            <div class="card-footer">
                                <button type="submit"
                                    style="background: greenyellow;     border-radius: 5px; padding:3px">Create
                                    Category</button>
                            </div>
